...
<?php   $stmt = $mysqli->query("SELECT COUNT(stock) AS numberofstock FROM tbl_inventory WHERE stock <= minimum") or die(mysqli_error($mysqli));
     ...
     ?>
        ...
        $categoryrow = $mysqli->query("SELECT * FROM tbl_category");
                ...
                <div class="row">
                    <div class="col-md-12">
                                ...
                                <input type="hidden" id="id" value="<?php echo $id ?>">
                                            ...
                                            <div class="col-lg-4 neym">Company name:</div>
                                            <br>
                                            <div class="col-lg-8 col-xs-12">
                                                <input type="text" id="companyname" value="<?php echo $companyname; ?>" required class="form-control text-uppercase" placeholder="company name" >
                                                <label class="lbl">*required</label>
                                                <br>
                                                <br>
                                            </div>
                                    
                                            <div class="col-lg-4 neym">Contact number:</div>
                                            <div class="col-lg-8 col-xs-12">
                                                <input type="number" id="contactnumber" value="<?php echo $contactnumber; ?>" class="form-control">
                                                <br>
                                                <br>
                                            </div>
  
                                            <div class="col-lg-4 neym">Address:</div>
                                            <div class="col-lg-8 col-xs-12">
                                                <input type="text" id="address" placeholder="address" value="<?php echo $address; ?>" required class=" form-control">
                                                <p id="error"></p>
                                                <br>
                                                <br>
                                                <br>
                                    ...
                                    <div class="col-lg-3 col-xs-3 float-right">
                                                <?php if ($update==true): ?>
                                                    <a href="supplier.php" type="button" class="btn btn_cancel" style="color:black;">Cancel</a>
                                                    <input type="submit" id="supplier_update" value="Update" class="btn btn-info">
                                                <?php else: ?>
                                                    <a href="supplier.php" type="button" class="btn btn_cancel" style="color:black;">Cancel</a>
                                                    <input type="submit" id="supplier_save" value="Submit" class="btn btn-primary float-right">
                                                <?php endif; ?>
                                                </div>`
        ...
        $('#supplier_save').click(function(){
          ...
          if(name !=''){
            $.ajax({
                url:"PROCESS.php",
                method:"POST",
                data:{sname:name,saddress:address,scontact:contact},
            ...
            document.getElementById('error').innerHTML = "Enter a company name";
            document.querySelector('#error').style.color = "#dd0000";
            document.querySelector('#error').style.fontWeight = "bold";
            document.querySelector('#error').style.marginTop = "10px";
          }
        ...
        var name = document.getElementById('companyname').value;
          ...
          var id = document.getElementById('id').value;
            ...
            $.ajax({
                url:"PROCESS.php",
                method:"POST",
                data:{pname:name,paddress:address,pcontact:contact,pid:id},
                success:function(data)
                {
                    $('#error').html(data);
                    var a = document.getElementById('error').innerHTML;
                    switch(a){
                        case 'Updated':
                            document.querySelector('#error').style.display = "none";
                            alert("Supplier successfuly updated");
                            window.location = "supplier.php";

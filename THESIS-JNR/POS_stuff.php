...
<?php $result = $mysqli->query("SELECT * FROM tbl_inventory");
?>
  <body>
        <!-- Page Content  -->
      <div id="content" class="p-3 p-md-3">
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
          ...
          <p> <img src="images/employee.png" class="img"  alt=""> Hi, <?php echo $_SESSION['username']; ?></p>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              ...
              <li class="nav-item active">
                    <a class="nav-link" href="staff-installment.php">Installment <span class="badge" style="background:red;color:white;width:20px;border-radius:10px;margin-left:10px" id="noti_number1"></span></a>
                </li>
                <li class="nav-item active">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body row mymodal2body">
                                    ...
                                    <div class="col-lg-5">
                                        <input type="hidden" id="user" value="<?php echo $_SESSION['username']; ?>" name="user">

...
<html lang="en">
  ...
  <link rel="icon" type="image/png" sizes="16x16" href="images/tubat-logo.jpg">
    ...
    <link href="mycss/table1.css" rel="stylesheet">
    <link href="mycss/sidescrollbar.css" rel="stylesheet">
    <link href="mycss/supplieraaction.css" rel="stylesheet">
...
<?php $account = $mysqli->query("SELECT * FROM tbl_account");
        ...
        $result1 = $mysqli->query("SELECT * FROM tbl_supplier"); ?>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="tabletop"></div>
                                            <div class="table-responsive thayt">
                                                <table class="teybol  table-striped" id="table">
                                                        <thead>
                                                      ...
                                                      <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-uppercase"><?php
                                                              if($row['address'] === ''){
                                                                echo 'No Address Record';
                                                              }else{
                                                                echo $row['address'];
                                                              }
                                                            ?></td>
                                                            <td class="text-uppercase" style="display:none"><?php echo $row['id'];?></td>

                                                               <td>
                                                                <a style="text-design:none;float:right;margin-right:0px" class="aktyon" href="supplieraction.php?actionsupplier=<?php echo $row['id']; ?>">
                                                                <img src="images/action.png" class="piktur"></a>

                                                                <a style="text-design:none;float:right;margin-right:10px" class="delit" href="#" id="deleteSupplier" data-toggle="modal" data-target="#deletesupp">
                                                                <img src="images/delete.png" class="piktur"></a>
  ...
  <div class="modal fade" id="deletesupp">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row">
                                      ...
                                      <div class="col-12">
                                              ...
                                              <p>Are you sure you want to delete? : <span id="suppliername"></span> supplier</p>
                                      ...
                                      <div class="col-12">
                                        ...
                                        <button class="btn btn-default float-left" data-dismiss="modal">No</button>
                                        <button class="btn btn-info float-right" id="yes">Yes</button>
  ...
  <script>
    $(document).ready(function(){
        $('#table, tbody').on('click', '#deleteSupplier', function(){
                var currow =$(this).closest('tr');
                var name =currow.find('td:eq(0)').text();
                var id_number =currow.find('td:eq(3)').text();
                document.getElementById('suppliername').innerHTML = name;
                document.getElementById('id').value = id_number;
        });
    });
    $(document).ready(function(){
      $('#yes').click(function(){
        var deletesupplier = document.getElementById('id').value;

      ...
      <div id="content" class="p-3 p-md-3">
        ...
        <div class="page-breadcrumb">
            <div class="row head">
                    ...
                    <h5>Low Stock inventory <span class="span"><?php echo $num_stock2; ?></span></h5>
                    </div>
                    <div class="col-6 align-self-center">
                    <a href="lowstock_freebies.php" class="free">Freebies <span class="span"><?php echo $num_stock1; ?></span></a>
                    </div>
                                                ...
                                                <table class="table-striped table-bordered">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td data-label="action" class="text-uppercase text-right">
                                                              <a style="text-design:none;float:right;margin-right:10px" class="aktyon" href="inventory.php?main_action=<?php echo $row['id']; ?>"><img src="images/action.png"class="imgg"> </a> </td>

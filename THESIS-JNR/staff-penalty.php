        ...
        <div class="row">
          <div class="col-lg-9">
             <div class="searchcontainer">
                                     ...
                                     <input placeholder="Search" type="text" name="search" id="search" class="searchinput"><img src="images/search_logo.png" class="imgg float-right" alt="search">
                           </div>
          </div>   

          <div class="col-lg-3">
          <div class="dropdown">
            <button class="button">Penalty<img src="images/arrow_down.png" class="imgg" alt=""></button>
            <div class="div">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                                            ...
                                            <div class="table-responsive thayt">
                                                ...
                                                <table class="teybol teboo" id="teybol">
                                                        ...
                                                        <tbody>
                                                        <?php
                                                        $result13 = $mysqli->query("SELECT * FROM tbl_installmentaccount  WHERE statuss = 'penalty'");
                ...
                $.ajax({
                                ...
                                success: function (data) {
                                  alert("Payment successfuly stored");
                                   window.location= 'staff-penalty.php';
                                }
                });
            }
            else{
      ...
      //OPEN MODAL
       $(document).ready(function(){  
        $('.teybol, tbody').on('click','.btn_modal',function(){
                ...
                var bal =currow.find('td:eq(5)').text();
                var total =currow.find('td:eq(4)').text();

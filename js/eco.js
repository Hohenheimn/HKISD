...
// Google Analytics
(function (i, s, o, g, r, a, m) { i['GoogleAnalyticsObject'] = r; i[r] = i[r] || function () { (i[r].q = i[r].q || []).push(arguments) }, i[r].l = 1 * new Date(); a = s.createElement(o), m = s.getElementsByTagName(o)[0]; a.async = 1; a.src = g; m.parentNode.insertBefore(a, m) })(window, document, 'script', path, 'ecoAnalytics')
// End Google Analytics

// isMobile.js
!(function (a) { var b = /iPhone/i, c = /iPod/i, d = /iPad/i, e = /(?=.*\bAndroid\b)(?=.*\bMobile\b)/i, f = /Android/i, g = /(?=.*\bAndroid\b)(?=.*\bSD4930UR\b)/i, h = /(?=.*\bAndroid\b)(?=.*\b(?:KFOT|KFTT|KFJWI|KFJWA|KFSOWI|KFTHWI|KFTHWA|KFAPWI|KFAPWA|KFARWI|KFASWI|KFSAWI|KFSAWA)\b)/i, i = /IEMobile/i, j = /(?=.*\bWindows\b)(?=.*\bARM\b)/i, k = /BlackBerry/i, l = /BB10/i, m = /Opera Mini/i, n = /(CriOS|Chrome)(?=.*\bMobile\b)/i, o = /(?=.*\bFirefox\b)(?=.*\bMobile\b)/i, p = new RegExp('(?:Nexus 7|BNTV250|Kindle Fire|Silk|GT-P1000)', 'i'), q = function (a, b) { return a.test(b) }, r = function (a) { var r = a || navigator.userAgent, s = r.split('[FBAN'); return typeof s[1] !== 'undefined' && (r = s[0]), this.apple = {phone: q(b, r), ipod: q(c, r), tablet: !q(b, r) && q(d, r), device: q(b, r) || q(c, r) || q(d, r)}, this.amazon = {phone: q(g, r), tablet: !q(g, r) && q(h, r), device: q(g, r) || q(h, r)}, this.android = {phone: q(g, r) || q(e, r), tablet: !q(g, r) && !q(e, r) && (q(h, r) || q(f, r)), device: q(g, r) || q(h, r) || q(e, r) || q(f, r)}, this.windows = {phone: q(i, r), tablet: q(j, r), device: q(i, r) || q(j, r)}, this.other = {blackberry: q(k, r), blackberry10: q(l, r), opera: q(m, r), firefox: q(o, r), chrome: q(n, r), device: q(k, r) || q(l, r) || q(m, r) || q(o, r) || q(n, r)}, this.seven_inch = q(p, r), this.any = this.apple.device || this.android.device || this.windows.device || this.other.device || this.seven_inch, this.phone = this.apple.phone || this.android.phone || this.windows.phone, this.tablet = this.apple.tablet || this.android.tablet || this.windows.tablet, typeof window === 'undefined' ? this : void 0 }, s = function () { var a = new r(); return a.Class = r, a }; typeof module !== 'undefined' && module.exports && typeof window === 'undefined' ? module.exports = r : typeof module !== 'undefined' && module.exports && typeof window !== 'undefined' ? module.exports = s() : typeof define === 'function' && define.amd ? define('isMobile', [], a.isMobile = s()) : a.isMobile = s() }(this));
// End isMobile.js
  ...
  var ecoClass = function () {
    ...
    this.video = function (video, poster) {
      if (typeof video === 'string') {
        console.log('video is type of ' + (typeof video))
    ...
    this.sendGA = function (category, action, value, nonInteraction) {
      ...
      if (nonInteraction !== undefined) {
        if (eco.config.getProperty('gaClient') !== undefined) {
          ecoAnalytics('send', 'event', category, action, eco.config.getCampaign(), value, {
            nonInteraction: true
          })
          ecoAnalytics('clientTracker.send', 'event', category, action, eco.config.getCampaign(), value, {
            nonInteraction: true
          })
        } else {
          ecoAnalytics('send', 'event', category, action, eco.config.getCampaign(), value, {
...
document.onreadystatechange = function () {
  switch (document.readyState) {
    case 'interactive':
      ...
      ecoAnalytics('create', eco.config.getProperty('ga'), 'auto')
      if (_debugMode !== false) {
        ecoAnalytics(function (tracker) {
					// console.log((new Date).getTime()-eco.time.load + "ms: " + (tracker.get('trackingId'))+ " ga created");
        })
      }

      ecoAnalytics('set', 'checkProtocolTask', null)
      ecoAnalytics('set', 'checkStorageTask', null)
      ecoAnalytics('send', 'screenview', {
        'appName': eco.config.getProperty('app'),
        'screenName': eco.config.getCampaign()
      })
      if (eco.config.getProperty('gaClient') !== undefined) {
        ecoAnalytics('create', eco.config.getProperty('gaClient'), 'auto', 'clientTracker')
        if (_debugMode !== false) {
          ecoAnalytics(function (clientTracker) {
						// console.log((new Date).getTime()-eco.time.load + "ms: " + (clientTracker.get('trackingId'))+ " gaClient created");
          })
        }
        ecoAnalytics('clientTracker.set', 'checkProtocolTask', null)
        ecoAnalytics('clientTracker.set', 'checkStorageTask', null)
        ecoAnalytics('clientTracker.send', 'pageview')
      }
      eco.sendGA('ad', 'load', '0', 'nonInteraction')
      if ('onpagehide' in window) {
        window.addEventListener('pagehide', function () {
          ecoAnalytics('send', 'event', 'ad', 'hide', eco.config.getCampaign(), eco.time.action(), {
            nonInteraction: true
          })
          if (eco.config.getProperty('gaClient') !== undefined) {
            ecoAnalytics('clientTracker.send', 'event', 'ad', 'hide', eco.config.getCampaign(), eco.time.action(), {
              nonInteraction: true
            })
          }
        }, false)

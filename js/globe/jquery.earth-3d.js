...
(function ($) {
  $.widget('ui.earth3d', {
    options: {
      texture: 'http://dottylabs.com/work/economist/telstra/wp-content/themes/Telstra-child/images/earth1024x1024.jpg',
      sphere: {
        tilt: 0,
        turn: 0,
        r: 10
      ...
      onInitLocation: function (location, widget) {
        ...
        $elem.click(function () {
          // console.log(this.earth.getRadius()/2);
          // console.log('posvar', widget.posVar);
          widget.options.defaultSpeed = 0

          // widget.posVar = 86399653.01521577;
        })

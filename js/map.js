(function () {
  ...
  (function (t, e) {
    ...
    n.fn[g] = function () {
      var t, r
      r = arguments[0], t = arguments.length >= 2 ? e.call(arguments, 1) : []
      if (d[r]) {
    ...
    n[m] = function () {
      var t, n
      n = arguments[0], t = arguments.length >= 2 ? e.call(arguments, 1) : []
      if (h[n]) {
...
telstraMap(jQuery, window)

// Map modal
function locationSelect () {
  var pin = $('.map-location-marker')
  var mapWrapper = $('.map')
  var selectedItem = $('.carousel-inner')
  var controls = $('.carousel-control')
  var mapPinsContainer = $('.map-pins-container')
  var mapExit = $('.map-pins')
    // pin.click(function() {
    ...
    //         $('.map-location-marker.active').removeClass('active');
...
function mapCarousel () {
  var $carousel = $('#carousel-custom') // get a reference
  $carousel.carousel()
  $carousel.bind('slide.bs.carousel', function (e) { // attach its event
    ...
    $('.carousel-indicators a').removeClass('active') // remove active class from all the a of carousel indicator

    var indx = $(current).index() // get its index
    if ((indx + 1) > $('.carousel-indicators a').length) { indx = -1 } // if index exceeds total length of indicators present set it to -1
    $('.carousel-indicators a:nth-child(' + (indx + 1) + ')').addClass('active') // set the respective indicator active
    console.log($(this))
  })
